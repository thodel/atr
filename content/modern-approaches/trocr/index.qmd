...
Community fine-tuned TrOCR models for specific historical collections are increasingly available on Hugging Face (search for `trocr historical`). The [dh-unibe](#dh-unibe-models) collection below is a good example from a digital humanities lab context.

## DH Bern (dh-unibe) Models {#dh-unibe-models}

The Digital Humanities Lab at the University of Bern publishes several TrOCR fine-tunes on Hugging Face under the [dh-unibe](https://huggingface.co/dh-unibe) organisation. All four public HTR models below are MIT-licensed and loadable with the standard Transformers snippet above — just swap in the model ID.
...
::: {.model-meta}
[dh-unibe/trocr-kurrent]{.model-badge}
[MIT]{.model-badge}
[333.9 M params]{.model-badge}
[German · 19th c.]{.model-badge .lang}
[6.1K downloads]{.model-badge .metric}
[DOI 10.57967/hf/0442]{.model-badge}
:::
...
::: {.model-card}
#### [trocr-kurrent-XVI-XVII](https://huggingface.co/dh-unibe/trocr-kurrent-XVI-XVII)

German Kurrent and early modern German scripts from the **16th–18th century**.

::: {.model-meta}
[dh-unibe/trocr-kurrent-XVI-XVII]{.model-badge}
[MIT]{.model-badge}
[333.9 M params]{.model-badge}
[German · 16th–18th c.]{.model-badge .lang}
[9.1K downloads]{.model-badge .metric}
[DOI 10.57967/hf/0441]{.model-badge}
:::
...
::: {.model-card}
#### [trocr-medieval-escriptmask](https://huggingface.co/dh-unibe/trocr-medieval-escriptmask)

Multi-language **medieval** manuscripts (German, French, Latin, Dutch).

::: {.model-meta}
[dh-unibe/trocr-medieval-escriptmask]{.model-badge}
[MIT]{.model-badge}
[333.9 M params]{.model-badge}
[German · French · Latin · Dutch]{.model-badge .lang}
[DOI 10.57967/hf/1436]{.model-badge}
:::
...
::: {.model-card}
#### [trocr-essoins-middle-latin](https://huggingface.co/dh-unibe/trocr-essoins-middle-latin)

**Medieval Latin legal texts** in Anglicana script (English common law records).

::: {.model-meta}
[dh-unibe/trocr-essoins-middle-latin]{.model-badge}
[MIT]{.model-badge}
[558.2 M params]{.model-badge}
[Latin · Medieval]{.model-badge .lang}
[DOI 10.57967/hf/4634]{.model-badge}
:::

The largest model in the set (558 M parameters — large-scale encoder). Fine-tuned on the [`digital-history-bielefeld/image-text_anglicana-legal-texts`](https://huggingface.co/datasets/digital-history-bielefeld/image-text_anglicana-legal-texts) dataset, using [`magistermilitum/tridis_HTR`](https://huggingface.co/magistermilitum/tridis_HTR) as the base rather than a standard TrOCR checkpoint. Suited for English legal records (plea rolls, essoins) in 13th–14th century Anglicana.
