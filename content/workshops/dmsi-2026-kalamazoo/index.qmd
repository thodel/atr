...
| 10:40 | 15 min | [Interactive Transcription Environments (ITEs)](#ites) | [eScriptorium](../../escriptorium/index.qmd) |
...
### Interactive Transcription Environments (ITEs) {#ites}

**What is an ITE?**
: A web-based platform that supports the full HTR workflow in a graphical interface: image import, layout annotation, transcription, model training, and export. ITEs make HTR accessible without requiring command-line expertise.
