...
- **Spell checking / language model correction** — using n-gram or neural language models to correct likely misrecognitions
...
Before training any model, a project must define its **transcription policy** — the rules governing how text is encoded. Key choices include:
...
| **Transkribus** | Freemium / commercial | PyLaia / custom | Mature ecosystem, large community, many pre-trained models |
...
- Mühlberger, G. et al. (2019). Transforming scholarship in the archives through handwritten text recognition. *Journal of Documentation*, 75(5).
- Springmann, U., & Lüdeling, A. (2017). OCR of historical printings with an application to building diachronic corpora. *arXiv:1703.09550*.
- Kiessling, B. et al. (2019). BADAM: A public dataset for baseline detection in Arabic-script manuscripts. *ICDAR*.
