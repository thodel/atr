...
::: {.tip-box}
**eScriptorium vs. Transkribus:** Both platforms offer layout analysis and HTR training. eScriptorium is open source and uses Kraken; Transkribus is commercial and uses PyLaia. eScriptorium is better for research projects requiring full control over training data and models; Transkribus has a larger pre-existing model library and a more polished user interface.
:::
...
::: {.tip-box}
**Fine-tuning vs. training from scratch:** For most historical document projects, fine-tuning a strong base model (such as [CATMuS Medieval](../models/open-source/index.qmd)) on 20–100 manually transcribed pages yields dramatically better results than training from scratch, especially when data is scarce.
:::
...
| University of Bern (DH) | Internal | Staff / project members |
...
> Kiessling, B., Stoekl Ben Ezra, D., & Miller, M. T. (2019). BADAM: A public dataset for baseline detection in Arabic-script manuscripts. In *Proceedings of the 5th International Workshop on Historical Document Imaging and Processing* (pp. 19–24). ACM.
